...
ln -s code/jknoxdev/notes/configs/fish/config.fish .config/fish/config.fish
ln -s /home/arx/code/jknoxdev/notes/configs/fish/config.fish .config/fish/config.fish
